...
let pers3 =  new Persona("Lara");

console.log(pers3._nom);
console.log(pers3.edat);

pers3.caminar();		//utilitzant un mètode
pers3.caminar(10);		//utilitzant el mateix mètode però sobrecàrregat (no funciona a JS)
